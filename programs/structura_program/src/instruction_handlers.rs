...
pub fn update_milestone_handler(
...
pub struct DistributeRewards<'info> {
    ...
    /// The user initiating distribution (e.g. project owner)
    pub user: Signer<'info>,
}

pub fn distribute_rewards_handler(
    ...
    msg!(
        "Distributing {} $STURA tokens for project: {}",
        amount,
        project_account.name
    );
